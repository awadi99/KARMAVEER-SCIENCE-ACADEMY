...
export default function Hero() {
    ...
    const buttonClass = "px-6 py-3 md:px-8 md:py-3.5 font-semibold text-sm rounded-lg transition-all active:scale-95";

    return (
        <section
            id="hero"
            /* We keep relative positioning and high z-index for content 
               to ensure HeroWaves doesn't cover text/buttons */
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-16 items-center">
                    ...
                    <div className="text-left order-2 lg:order-1">
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#111827] dark:text-[#F1F5F9] leading-[1.15] mb-4 md:mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                            <Button
                                ...
                                className={`${buttonClass} bg-[#2563EB] dark:bg-[#3B82F6] text-white hover:bg-opacity-90 shadow-lg w-full sm:w-auto`}
                            >
                            ...
                            <button
                                ...
                                className={`${buttonClass} bg-white dark:bg-[#1E293B] text-[#111827] dark:text-[#F1F5F9] border border-[#D1D5DB] dark:border-[#334155] hover:bg-gray-50 dark:hover:bg-[#243347] w-full sm:w-auto`}
                            >
                                View Courses
                            </button>
                        </div>
                    ...
                    <div className="relative order-1 lg:order-2">
                        <div className="bg-white dark:bg-[#1E293B] p-2 md:p-3 xl:p-4 rounded-2xl md:rounded-3xl shadow-xl lg:shadow-2xl border border-gray-100 dark:border-white/5 relative z-10">
                            <img
                                src="/image/hero_bg.jpg"
                                alt="Student Success"
                                className="rounded-xl md:rounded-2xl w-full object-cover aspect-video lg:aspect-[4/5] xl:aspect-[5/4] max-h-[300px] sm:max-h-[400px] lg:max-h-none"
                            />

                            <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-[#10B981] dark:bg-[#22C55E] text-white p-3 md:p-5 rounded-xl md:rounded-2xl shadow-xl z-20">
            ...
            {/* HERO WAVES POSITIONING:
                Placed at the bottom of the section.
                z-0 ensures it stays behind the max-w-7xl content (which is z-10).
            */}
